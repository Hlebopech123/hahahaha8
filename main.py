...
from PyQt5.QtWidgets import (QApplication, QWidget, QTableWidget, QTableWidgetItem, QTabWidget,
                             QPushButton, QHBoxLayout, QDialog,
                             QLineEdit, QVBoxLayout,
                             QDialogButtonBox, QSizePolicy, QHeaderView, QMessageBox, QFormLayout, QTimeEdit)
